...
const styles: Record<string, CSSProperties> = {
  ...
  blob1: {
    ...
    height: "55%",
    background:
      "radial-gradient(ellipse at center, rgba(65, 152, 115, 0.18) 0%, transparent 70%)",
  ...
  blob2: {
    ...
    height: "45%",
    background:
      "radial-gradient(ellipse at center, rgba(201, 169, 98, 0.12) 0%, transparent 60%)",
