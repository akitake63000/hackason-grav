...
GEMINI_MODEL_LIGHT = os.getenv("GEMINI_MODEL_LIGHT", "gemini-1.5-flash")
GEMINI_MODEL_HEAVY = os.getenv("GEMINI_MODEL_HEAVY", "gemini-1.5-pro")
GEMINI_MODEL_VISION = os.getenv("GEMINI_MODEL_VISION", "gemini-1.5-pro")  # For photo analysis
