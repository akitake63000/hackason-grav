...
ACTIONS_CATALOG: list[dict] = [
    ...
    # --- New Additions to reach 48 ---
    {
        ...
        "duration": "毎日",
        "reason": "ホルモン生成のサポート",
        "explanation": "ビタミンEは「若返りのビタミン」とも呼ばれ、ホルモンバランスや血管の健康を保ちます。",
        "tips": ["素焼きのアーモンドを選ぶ", "サラダにトッピングする", "食べ過ぎない（1日10粒程度）"],
        "targets": {"hormone": 0.8, "blood_flow": 0.5},
    },
    {
        "id": "emotional_tears",
        "name": "感動して泣く（涙活）",
        ...
        "duration": "週末",
        "reason": "コルチゾールの排出",
        "explanation": "情動の涙にはストレス物質が含まれており、流すことで心身がデトックスされます。",
        "tips": ["感動する映画を見る", "泣ける小説を読む", "思いっきり泣く時間を作る"],
        "targets": {"hormone": 0.6, "stress": 0.9},
    },
    {
        "id": "morning_shower",
        "name": "朝の熱めシャワー",
        ...
        "duration": "5分",
        "reason": "交感神経スイッチON",
        "explanation": "少し熱めのお湯を浴びることで交感神経が刺激され、体内時計が覚醒モードに入ります。",
        "tips": ["首の後ろに当てる", "最後は少しぬるくする", "短時間で済ませる"],
        "targets": {"circadian": 0.8, "blood_flow": 0.6},
    },
    {
        "id": "fixed_meal_time",
        "name": "食事時間の固定",
        ...
        "duration": "毎日",
        "reason": "体内リズムの同調",
        "explanation": "毎日同じ時間に食事を摂ることで、内臓の時計遺伝子が整い、体のリズムが整います。",
        "tips": ["ランチの時間を決める", "夕食が遅くなるなら分食", "休日はズレても1時間以内"],
        "targets": {"circadian": 0.9, "hormone": 0.4},
    },
    {
        "id": "calf_raise",
        ...
        "duration": "20回",
        "reason": "第2の心臓の活性化",
        "explanation": "ふくらはぎの筋肉を動かすことで、下半身に滞った血液を心臓に押し戻します。",
        "tips": ["歯磨き中に", "エレベーター待ちの時間に", "かかとを床につけない"],
        "targets": {"blood_flow": 0.9, "circadian": 0.3},
    },
    {
        "id": "ankle_rotation",
        "name": "足首回し",
        ...
        "duration": "左右10回",
        "reason": "末端血流の改善",
        "explanation": "足首が硬いと血流が滞りがち。大きく回してポンプ機能を助けましょう。",
        "tips": ["お風呂の中で", "寝る前に布団の上で", "ゆっくり大きく回す"],
        "targets": {"blood_flow": 0.8, "stress": 0.3},
    },
    {
        "id": "singing_high",
        "name": "歌を歌う",
        ...
        "duration": "1曲",
        "reason": "ストレス発散・呼吸改善",
        "explanation": "大きな声を出すことは最高のストレス解消。腹式呼吸にもなり自律神経が整います。",
        "tips": ["お風呂で歌う", "ドライブ中に歌う", "カラオケに行く"],
        "targets": {"stress": 0.9, "blood_flow": 0.5},
    },
    {
        "id": "pet_video",
        "name": "動物動画を見る",
        ...
        "duration": "5分",
        "reason": "オキシトシン的効果",
        "explanation": "かわいい動物を見るだけでも、脳は癒やされストレス値が下がることが分かっています。",
        "tips": ["猫や犬の動画を見る", "赤ちゃんの動画もOK", "寝る前のリラックスタイムに"],
        "targets": {"stress": 0.8, "hormone": 0.3},
    },
]
